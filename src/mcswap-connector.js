...
class mcswapConnector {
  constructor(_wallets_=[],emitter=false){
    ...
    const set_wallets = [];
    for(let i=0;i<_wallets_.length;i++){_wallets_[i]=_wallets_[i].trim();}
